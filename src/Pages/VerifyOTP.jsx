...
const VerifyOTP = () => {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const res = await axios.post("https://backend-2-5vig.onrender.com/api/auth/verify-otp", { email, otp: otp.join('') });
  ...
  const handleResendOTP = async () => {
    setResending(true);
    try {
      const res = await axios.post("https://backend-2-5vig.onrender.com/api/auth/resend-otp", { email });
